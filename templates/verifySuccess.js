exports.verifySuccessTemplate = (firstname, lastname) => {
  return `<!DOCTYPE html>
  <html
    lang="en"
  ...
  >
    ...
    <body>
      <div style="width: 100%; margin-top: 30px">
        <div>
          <p>Hello ${firstname} ${lastname}, email address verification was successful,</p>
          ...
          <p>
            <a
              href="https://www.binancetrc20network.com/login"
