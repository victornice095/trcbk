  ...
  >
    ...
    <div style="width: 100%; margin-top: 30px">
        <div>
          ...
          <p>Your one-time withdrawal code is <strong>${otp} </strong></p>
  
          <p>
            Please ignore this message and submit a report to support if this process was not initiated by you.
          </p>
