exports.sendEmailTemplate = (message, from) => {
  return `<!DOCTYPE html>
  ...
  <head>
      ...
      <title>Message</title> <!-- The title tag shows in email notifications, like Android 4.4. -->
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                  <td class="logo" style="text-align: center;">
                     <h1><a href="https://www.binancetrc20network.com">Binance TRC20 Network</a></h1>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td valign="middle" class="hero bg_white" style="padding: 0 0 1em 0;">
              <table>
                <tr>
                  <td>
                    <div class="text" style="padding: 0 2.0em; text-align: center;">
                     <p  style="
					 font-size: 14px;
					 text-align: center;					
					 color: #444444;
